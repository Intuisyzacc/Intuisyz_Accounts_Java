...
String ss3="select * from account_transactions_v3 where type='Voucher' and company_name=?1";
...
String ss14="select * from account_transactions_v3 where type='Voucher' AND company_name=?3 AND tran_Date BETWEEN ?1 AND ?2";
...
String ss16="select * from account_transactions_v3 where (type='Contra' AND  company_name=?1)  AND   (status='paid'  OR status='not paid' OR status='1') order by tranID DESC";
...
String ss27="select * from account_transactions_v3 where type='Contra' AND  company_name=?3  AND (status='paid' OR status='not paid' OR status='1') AND tran_Date BETWEEN ?1 AND ?2";
...
String ss30="select * from account_transactions_v3 where type='Receipt' and company_name=?1";
...
String ss41="select * from account_transactions_v3 where type='Receipt' AND company_name=?3 AND tran_Date BETWEEN ?1 AND ?2";
...
String ss73="select * from account_transactions_v3 where company_name=?1 ORDER BY tranID DESC";
...
String ss76="select * from account_transactions_v3  where  company_name=?5 AND (dbt_ac=?3 AND crdt_ac=?4) AND tran_Date  BETWEEN ?1 AND ?2 ORDER BY tranID DESC";
...
String ss77="select * from account_transactions_v3  where company_name=?5 AND (dbt_ac=?4 OR crdt_ac=?3) AND tran_Date  BETWEEN ?1 AND ?2 ORDER BY tranID DESC";
...
String ss78="select * from account_transactions_v3  where company_name=?4 AND  dbt_ac=?3  AND tran_Date  BETWEEN ?1 AND ?2 ORDER BY tranID DESC";
...
String ss79="select * from account_transactions_v3  where company_name=?4 AND  crdt_ac=?3  AND tran_Date  BETWEEN ?1 AND ?2 ORDER BY tranID DESC";
...
String ss80="select * from account_transactions_v3  where company_name=?3 AND  tran_Date  BETWEEN ?1 AND ?2 ORDER BY tranID DESC";
